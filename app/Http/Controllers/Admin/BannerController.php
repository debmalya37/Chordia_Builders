...
$data   = $request->all();
if ($request->get('innerbanner'))
$data['innerbanner']=1;
else
$data['innerbanner']=0;
if(!empty($request->file('image'))){    
$photo = GeneralHelper::uploadimage($request->file('image'),$this->directory,9);
$data['image'] = $photo;
}
...
return view('admin.pages.banner',compact('banners'),['head' => 'Banner']);
}
...
if(!empty($get_record)){
return view('admin.pages.addbanner',compact('get_record'),['head' => 'Edit Banner']);
} else {
