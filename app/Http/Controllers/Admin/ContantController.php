...
class ContantController extends Controller{
	...
	$contants = Contant::orderBy('title', 'ASC')->get();
	return view('admin.pages.contant',compact('contants'),['head' => 'Contant']);
	}
	...
	if(!empty($get_record)){
	return view('admin.pages.addcontant',compact('get_record'),['head' => 'Edit Contant']);
	}else{
