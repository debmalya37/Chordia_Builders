...
return view('blogs',compact('blogs','blogcats','myblogs','contant'));	
} 
...
return view('blog-detail',compact('blogcats','info','myblogs','contants'));
}	
}
...
return view('blogs',compact('blogscates','myblogs','blogcats','info'));
}	
} 
