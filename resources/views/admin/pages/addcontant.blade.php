...
<div class="form-group">
    <label>Heading [Home Page]</label>
    <?php echo Form::textarea('heading', null,['class'=>'form-control','rows' => 0, 'cols' => 0]); ?>
    <span class="text-danger"> </span>
    <span class="text-danger small heading_error"> </span>    
   </div>

   <div class="form-group">
    <label>Sub Heading [Inner Page]</label>
    <?php echo Form::textarea('sub_heading', null,['class'=>'form-control','rows' => 0, 'cols' => 0]); ?>
    <span class="text-danger"> </span>
    <span class="text-danger small sub_heading_error"> </span>    
   </div>
