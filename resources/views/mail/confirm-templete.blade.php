...
<h1 style="font:bold 26px Arial,sans-serif!important;color:#000000!important;margin:0;padding:0;text-align:left">Enquiry from Chordia Builders</h1>
...
<tbody><tr>
  ...
  <strong>Dear {{ $data['name'] }},</strong><br /><br />
    ...
    Thanks for enquiry. You will hear from our executive with complete project detail.  <br> <br>
...
This e-mail was sent from <br> <a href="http://{{ $data['weburl'] }}" rel="nofollow" target="_blank" >{{ $data['weburl'] }}</a></p>
</div>
</td>
</tr>
</tbody></table>
