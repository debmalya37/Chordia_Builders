...
<h1 style="font:bold 26px Arial,sans-serif!important;color:#000000!important;margin:0;padding:0;text-align:left">Car Enquiry from {{ $data['title'] }}</h1>
</div>
</td>
</tr>
</tbody></table>
...
<tr>
<td width="100"><strong>Arrival Date : </strong></td>
<td>{{ $data['arrival_date'] }}</td>
</tr>


<tr>
<td width="100"><strong>Arrival Place : </strong></td>
<td>{{ $data['arrival_place'] }}</td>
</tr>


<tr>
<td width="100"><strong>No of Days  : </strong></td>
<td>{{ $data['no_days'] }}</td>
</tr>


<tr>
<td width="100"><strong>No of Travel : </strong></td>
<td>{{ $data['notravelers'] }}</td>
</tr>

<tr>
<td width="100"><strong>Hotel Required : </strong></td>
<td>{{ $data['hotel_required'] }}</td>
</tr>

<tr>
<td width="100"><strong>Tour Budget : </strong></td>
<td>{{ $data['tour_budget'] }}</td>
</tr>
...
<tr>
<td width="100"><strong>Page Url : </strong></td>
<td>{{ $data['page_url'] }}</td>
</tr>
...
This e-mail was sent from a car enquiry form <br> <a href="{{ $data['weburl'] }}" rel="nofollow" target="_blank" >{{ $data['weburl'] }}</a></p>
</div>
</td>
</tr>
</tbody></table>
...
Copyright &copy; 2021 {{ $data['title'] }}. All Rights Reserved. 
